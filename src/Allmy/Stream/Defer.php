...
class AlreadyCalledError extends Exception {
...
public function execute(callable, *args, **kw):
    """
...
/*
public function maybeDeferred(f, *args, **kw):
    """
...
public function timeout(deferred):
...
public function setDebugging(on):
    """
...
class Deferred {
    ...
    public $called = False;
    public $paused = 0;
    private $_debugInfo = null;
    private $_suppressAlreadyCalled = False;
    private $callbascks = array();
    ...
    # used.
    public $_runningCallbacks = False;

    # Keep this class attribute for now, for compatibility with code that
    # sets it directly.
    public $debug = False;

    private $_chainedTo = null;
        /**
    ...
    public function addCallbacks($callback, $callbackArgs=null, $errback=null, $errbackArgs=null) {
        $cbs = ((callback, callbackArgs),
               (errback or (passthru), errbackArgs))
    ...
    public function addErrback($errback, $args) {
        """
        Convenience method for adding just an errback.

        See L{addCallbacks}.
        """
        return self->addCallbacks(null, $errback, null, $args)
    }
        ...
        See L{addCallbacks}.
         */
    public function addBoth($callback, $args) {
        return $this->addCallbacks($callback, $args, $callback, $args);
    }

    public function chainDeferred($d) {
        """
    ...
    public function errback($fail=null) {
        """
    ...
    public function _startRunCallbacks(self, result):
        if self.called:
    ...
    public function _continuation(self):
        """
    ...
    public function _runCallbacks(self):
        """
