...
abstract class Factory implements IProtocolFactory, ILoggingContext {
    ...
    */
     ...
     */
    abstract public function startFactory() {
     ...
     * directly.
     */
    abstract public function stopFactory() {
    }
